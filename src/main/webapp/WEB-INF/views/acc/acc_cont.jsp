		...
		<div class="shop_info">
			<ul class="info_cate">
         	...
         	<ul class="info_cont">
            	...
            	<li><p>
                  	할인쿠폰 &nbsp;&nbsp;<button id="getCoupon">발급받기</button>
               	</p></li>
         	</ul>
      	</div>
   	</div>
            ...
            <div class="refund_process">
            	<h4>환불절차 안내</h4>
               	...
               	<ul>
                  	...
                  	<li>&#45; 패널티는 포인트에서 선차감되어 환불되며, 패널티 금액이 포인트 사용 금액보다 높을 경우 잔여 패널티 금액은 결제하신 결제수단(신용카드 등)에서 차감 후 환불됩니다. 
                     	단, 패널티 금액이 신용카드 결제금액보다 높을 경우에는 고객센터로 문의 하시기 바랍니다.</li>
               	</ul>
            </div>
               	...
               	<div class="review_rating_form">
                  	<form action="#" method="post" id="reviewForm">
                     	<table class="review_write">
	                        ...
	                        <tr>
	                           	<th colspan="2">
	                              	<textarea rows="10" cols="30" id="review_cont" name="review_cont" placeholder="후기를 입력해주세요"></textarea>
	                           	</th>
	                        </tr>
	                        <tr>
	                           	<td>
	                              	<input type="submit" value="등록" onclick="submit_check();" class="ReviewWriteBtn">
	                           	</td>
	                        </tr>
	                   	</table>
	               	</form>
                           		...
                           		<table class="detail_review_table">
                             		<tr>
                                 		...
                                 		<td style="text-align: left;">
                                    		${review.memId}<label style="color: gray;">| ${review.review_date}</label>
                                 		</td>
