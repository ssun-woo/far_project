 			...
 			<div id="service_content" class="shop_cont_div">
                ...
                <div id="information_content" style="display:none;" class="shop_cont_div">
            		...
            		<h3>판매자</h3><hr><p>판매자 정보 보기</p></div></div>
                       ...
                       <!-- 환불정책 -->
                       <div id="cancellation_content" style="display:none;" class="shop_cont_div">
                       <div class="cancellation_policy">
                ...
                <li>
                    ...
                    <p>${review.mem_id} ${review.review_date}</p>
                    	...
                    	<input type="button" value="수정" class="review_edit"> <input type="button" value="삭제" class="review_del">
...
<form action="#">
    <table class="review_write" method="post">
        <tr>
            <td><label for="review_title">제목&nbsp;&nbsp;</label>
                <input type="text" id="review_title" name="review_title"></td>
            <td><label for="mem_id"> 아이디 </label><input type="text" id="mem_id" name="mem_id"></td>
        </tr>
        <tr>
            <td> 상품명 <input type="text" id="review_goods"></td>
            <td class="starEx">
        ...
        <tr>
            <td colspan="2"><textarea rows="10" cols="30" id="review_content"></textarea></td>
        </tr>
        <tr>
            <td><input type="submit" value="등록" onclick="submit_check();" class="ReviewWriteBtn"></td>
        </tr>
    </table>
</form>
 </div>                         
