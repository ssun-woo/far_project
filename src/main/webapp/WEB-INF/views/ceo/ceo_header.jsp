...
<link rel="stylesheet" type="text/css" href="../css/reservation_main.css">
...
<body>
	...
	<div id="ceo_middle">
		<div id="ceo_list">
			...
			<div class="ceo_list" id="shop" onclick="location='/ceo/store_list'">
				<img src="../images/ceo/shop.png">
				<p>가게관리</p>
			</div>

			<div class="ceo_list" id="center">
				<a href="/customer_service"> <img src="../images/ceo/center.png">
					<p>고객센터</p>
				</a>
			</div>
