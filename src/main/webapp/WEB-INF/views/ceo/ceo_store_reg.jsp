							...
							<div class="storeRegistration">
								...
								<div class="storeAddressArea">
									<div class="storeAddressF">
										...
										<div class="storeAdrressB">
										
										<input type="text" id="storeAddressFirst"  name="storeAddr1" placeholder="주소">
										<input type="button" onclick="sample6_execDaumPostcode()" value="우편번호 찾기"></div><br>
									</div>
								</div>
