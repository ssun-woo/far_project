...
<body>
    ...
    <div class="tabArea">
        <ul class="n1 nav nav-tabs" id="myTabs">
            ...
            <li class="nav-item">
                <a class="nav-link active" data-toggle="tab" href="#beauty">뷰티</a>
            </li>
        </ul>
    </div>
    <div id="tab-content">
        ...
        <div class="tab-pane fade show active" id="beauty">
                    ...
                    <li class="box_prd">
                        ...
                        <div class="box_text">
                            ...
                            <div data-row>
                                <div data-cell>
                                    <a href="">
                                        <h5 class="infoTitle">다교네일</h5>
                                    </a>
                                    <p class="infoSubTitle">회원권 구매시 +10000</p>
                                </div>
                                <div data-cell>
                            ...
                            <div data-row="bottom">
                                <div data-cell>
                                    ...
                                    <p class="info">경기도 고양시 일산동구 태극로</p>
                                </div>
                            </div>
                        </div>
                    </li>
                    ...
                    <li class="box_prd">
                        ...
                        <div class="box_text">
                            ...
                            <div data-row>
                                <div data-cell>
                                    <a href="">
                                        <h5 class="infoTitle">쓰담 헤어</h5>
                                    </a>
                                    <p class="infoSubTitle">회원권 구매시 두피케어</p>
                                </div>
                                <div data-cell>
                                    <div class="" infoPrice" tabindex="0">
                                        <p class="final">
